...
shopping_list = ["potatoes", "carrots", "rice"] # Fill in with some values
...
nutrition_facts = {"calories":"200", "sugar":"15grams", "Carbs":"30grams"} # Fill in with the nutrition facts from the label

print(nutrition_facts) # Print all the nutrition facts

print(nutrition_facts["calories"]) # Uncomment this line and pick a value to print individually
